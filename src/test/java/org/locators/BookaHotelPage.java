...
public class BookaHotelPage extends LibGlobal{
	...
	public void bookaHotelPage(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8) {
		...
		sendValue(getTxtFistName(), string);
		sendValue(getTxtLastName(), string2);
		sendValue(getTxtBillingAddress(), string3);
		sendValue(getTxtCreditcardNo(), string4);
		selectbyVisibleText(getSelCreditCardType(), string5);
		selectbyVisibleText(getSelExpMonth(), string6);
		
		selectbyVisibleText(getSelExpYear(), string7);
		sendValue(getTxtCvv(), string8);
